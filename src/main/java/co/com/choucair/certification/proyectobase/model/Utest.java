...
public class Utest {
     ...
     **/
    public Utest(String strFirtsName, String strLastName, String strEmail, String strMoth, String strDay, String strYear, String strCity, String strZip, String strCountry, String strComputer, String strVersion, String strLanguage, String strMobileDevice, String strModel, String strOperatingSystem, String strPassword, String strRepassword, String question) {
     ...
     * Getter and Setter
     **/
    public String getStrFirtsName() {return strFirtsName;}

    public void setStrFirtsName(String strFirtsName) {this.strFirtsName = strFirtsName;}
    ...
    public String getStrMoth() {return strMoth;}

    public void setStrMoth(String strMoth) {this.strMoth = strMoth;}

    public String getStrDay() {return strDay;}

    public void setStrDay(String strDay) {this.strDay = strDay;}

    public String getStrYear() {return strYear;}

    public void setStrYear(String strYear) {this.strYear = strYear;}
    ...
    public String getStrComputer() {return strComputer;}

    public void setStrComputer(String strComputer) {this.strComputer = strComputer;}
    ...
    public String getStrMobileDevice() {return strMobileDevice;}

    public void setStrMobileDevice(String strMobileDevice) {this.strMobileDevice = strMobileDevice;}

    public String getStrModel() {return strModel;}

    public void setStrModel(String strModel) {this.strModel = strModel;}

    public String getStrOperatingSystem() {return strOperatingSystem;}

    public void setStrOperatingSystem(String strOperatingSystem) {this.strOperatingSystem = strOperatingSystem;}
    ...
    public String getStrRepassword() {return strRepassword;}

    public void setStrRepassword(String strRepassword) {this.strRepassword = strRepassword;}
